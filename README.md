...
[![](https://img.shields.io/badge/docs-godoc-blue.svg)](https://godoc.org/github.com/belphemur/go-webpbin)
...
```go get -u github.com/belphemur/go-webpbin```
...
|LIBWEBP_VERSION|`1.4.0`|The latest version for now. (2025/08/31)|
